...
def degree_progress(request):
	...
	math_2_on = title(chain(math_2_credit, compare_lists(all_courses, math_2)["similarities"]))
	...
	math_3_on = title(chain(math_3_credit, compare_lists(all_courses, math_3)["similarities"]))
	...
	physics_1_on = title(chain(physics_1_credit, compare_lists(all_courses, physics_1)["similarities"]))
	...
	cos_1_on = title(chain(cos_1_credit, compare_lists(all_courses, cos_1)["similarities"]))
