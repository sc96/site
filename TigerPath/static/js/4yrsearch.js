...
function search_courses() {
    ...
    $.ajax({
        ...
        success : function(json) {
            ...
            //}
            $('#courses-found').empty();
            var html = "<div class='col-md-12'><p><br><b>Matched Courses:</b></p><div class='list-group'>"; //Header
            for (var x in json.matched_courses){
                    ...
                    //Conditional lists for adding
                     if (courses[x][6] == 1 || courses[x][4] == 1){
                        Fall = true;
                     }
                     if (courses[x][3] == 1 || courses[x][5] == 1){
                        Spring = true;
                     }
                     if (courses[x][0].match("COS")){
                        CS = true;
                     }
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "form",
              { id: "course-search", className: "form-inline", action: true, method: "get", onSubmit: this.handleSubmit},
              React.createElement(
                "div",
                { className: "input-group col-md-12" },
                React.createElement("input", { type: "text", className: "form-control input-lg", placeholder: "Search for a course (e.g. COS 126 or General Computer Science)", id: "course-search-text", name: "q", value: this.state.value, onChange: this.handleChange}),
                React.createElement(
                  "span",
